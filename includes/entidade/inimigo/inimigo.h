         ...
         namespace Personagem{
            ...
            namespace Inimigo{
                ...
                public:
                    ...
                    Inimigo(sf::Vector2f pos, sf::Vector2f tam, const float vel, Jogador::Jogador *jogador,const float tempoAnimacaoAtaque, IDs::IDs ID, const float tempoAnimacaoDeLevarDano, const float tempoAnimacaoDeMorrer, float dano, Arma::Arma* arma);
                    ~Inimigo();
