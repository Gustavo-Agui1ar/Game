...
#include "../includes/entidade/Player/Skils/Rage.h"
#include "../includes/entidade/Player/Skils/Stamina.h"
...
namespace Game {
    ...
    namespace Entidade::Character::Player{
        ...
        public:
            ...
            void changeObserverEstate(const bool ative);
            ...
            void updateWeapon();
            void setProjetil(Weapon::Bullet* bullet);
            void trhowBullet();
