...
namespace Game::Entity::Character::Enemy{
     ...
     * 
     * @param position Initial position of the skeleton.
    ...
    /**
     * @brief Construct a new Skeleton object from JSON attributes.
     * 
    ...
    /**
     * @brief Initialize the animations for the skeleton.
     */
    ...
    /**
     * @brief Update the animation state of the skeleton.
     */
    ...
    /**
     * @brief Update the attack state of the skeleton.
     */
    ...
    /**
     * @brief Initialize the sound effects for the skeleton.
     */
