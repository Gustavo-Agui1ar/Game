...
namespace Game::Entidade::Character::Player::Skils {
    ...
    void Rage::bootRageBar() {
        ...
        rageTexture->loadFromFile("animations/Life/BarraEnergia.png");
    ...
    nlohmann::ordered_json Rage::saveRage(nlohmann::ordered_json json) {
        json["furia"] = getRage();
        json["emFuria"] = getInRage();
        json["entrandoEmFuria"] = getStartingRage();
        json["tempoEntrandoFuria"] = getTimeStartingRage();
        return json;
    }
}